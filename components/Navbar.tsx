      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-2">
            <span className="text-yellow-accent font-bold text-lg sm:text-xl tracking-tight">📚 StudyMate</span>
          </div>
              ...
              return (
                <Link 
                  ...
                  className={`flex items-center gap-2 transition-colors font-medium ${
                    pathname === link.href ? "text-yellow-accent" : "text-muted-foreground hover:text-white"
                  }`}
                >
              ...
              {!isAuthenticated ? (
                <div className="pt-4 pb-2 space-y-2">
                  <Link href="/sign-in" onClick={closeMobileMenu}>
                    <button className="w-full btn-primary text-sm px-4 py-2">
                      Sign In
                    </button>
                  </Link>
