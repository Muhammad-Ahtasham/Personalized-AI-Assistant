    ...
    try {
      ...
      if (
        ...
        return NextResponse.json(
          {
            error:
              'Failed to generate a proper learning plan. Please try again with a different topic or check your internet connection.',
          },
          { status: 500 }
        );
      }
