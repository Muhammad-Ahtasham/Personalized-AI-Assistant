          ...
          <>
            ...
            <div className="space-y-3 mb-6">
              <button
                ...
                className="w-full flex items-center justify-center px-4 py-2 border border-border rounded-md shadow-sm bg-muted text-sm font-medium text-white hover:bg-secondary focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-accent transition-colors"
              >
