...
export default function SignInPage() {
  ...
  const [loginStep, setLoginStep] = useState<"form" | "face">("form");
    ...
    <div className="flex justify-center items-center min-h-screen bg-gradient-to-b from-gray-50 to-gray-100">
      <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
        <h1 className="text-2xl font-bold text-center mb-6 text-gray-800">
          {loginStep === "face" ? "Sign In with Face" : "Welcome Back"}
        </h1>
        ...
        {loginStep === "form" && (
          <>
            ...
            <div className="mt-6">
              ...
              <button
                onClick={() => setLoginStep("face")}
                className="w-full mt-4 flex items-center justify-center px-4 py-2 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors"
              >
                <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 550 24">
        ...
        {loginStep === "face" && (
          <div className="space-y-4">
            <div className="mb-4">
              <label htmlFor="faceEmail" className="block text-sm font-medium text-gray-700 mb-1">
                Email Address
              </label>
              <input
                id="faceEmail"
